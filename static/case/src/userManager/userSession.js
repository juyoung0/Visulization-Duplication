    ...
    _.extend(parent,
        {
            ...
            newSession: function () {
                ...
                return $.ajax({
                    ...
                    data: reqObj,
                    success: function (data, status) {
                        if (data.success) userManager.logger('Create-Session', reqObj, 'Session');
            ...
            editSession: function () {
                ...
                return $.ajax({
                    ...
                    success: function (data, error) {
                        if (data.success) userManager.logger('Change-Session-Annotation', reqObj, 'Session');
            ...
            confirmDelSession: function () {
                ...
                return $.ajax({
                    ...
                    data: reqObj,
                    success: function (data, status) {
                        if (data.success) userManager.logger('Delete-Session', reqObj, 'Session');
            ...
            branchSession: function (session_name, reqObj) {
                ...
                return $.ajax({
                    ...
                    method: 'post',
                    success: function (data, status) {
                        if (data.success) userManager.logger('Branch-Session', reqObj, 'Session');
            ...
            successBranchSession: function (data, status) {
                if (!data.success) userManager.failAjax(data);
                userManager.getSessions();
            ...
            successShowSession: function (data, restore) {
                ...
                _.forEach(_.reverse(data.output), function (item, idx) {
                    ...
                    $.ajax({url: unit_path, method: 'post'}).done(function (data) {
                        ...
                        if (restore) $('#'+d.block_iden).remove();
                        unitManager.addUnit(d);
                    })
                });
            },
